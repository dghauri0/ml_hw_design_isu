# Start sim
vsim -voptargs=+acc work.tb_staged_mac
...
add wave -noupdate -label ACLK /tb_staged_mac/DUT0/ACLK
add wave -noupdate -label RESETN /tb_staged_mac/DUT0/ARESETN
...
# example from 381: add wave -noupdate -radix unsigned /tb_tpu_mv_element/s_iX
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/SD_AXIS_TDATA
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/MO_AXIS_TREADY
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/SD_AXIS_TVALID
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/SD_AXIS_TLAST
...
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/MO_AXIS_TDATA
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/SD_AXIS_TREADY
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/MO_AXIS_TVALID
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/MO_AXIS_TLAST
...
add wave -noupdate -divider {Standard Inputs}
add wave -noupdate /tb_staged_mac/ACLK
add wave -noupdate /tb_staged_mac/s_ARESETN
...
# example from 381: add wave -noupdate /tb_tpu_mv_element/DUT0/g_Weight/iLd


# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
add wave -noupdate -radix unsigned /tb_staged_mac/DUT0/*
